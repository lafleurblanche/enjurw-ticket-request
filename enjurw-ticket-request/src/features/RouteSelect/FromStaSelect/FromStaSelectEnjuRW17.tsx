...
import {
  EnjuRW17FromStaList01,
  EnjuRW17FromStaList02,
  EnjuRW17FromStaList03
 ...
 * * えんじゅ交通拯川線
 */
export const FromStaSelectEnjuRW17 = () => {
  ...
  const handleOnClick = (staName: string, staCode: string) => {
    if(staName !== '') {
      ...
      setIsRouteSelected(RouteName.ViaRouteEnjuRW17);
    }
  }
